...
import ApproveHero from "./assets/approve-hero.png";
import AnimationAccessRequest from "./assets/animation-access-request.png";
...
<Section bg="gray">
  <SectionVisuals title="Leverage Existing Tools" description={<>
    <p>
...
<Section bg="white">
<SectionVideo title="Demo Video" videoId="b_iqJm_o15I">
...
<Section bg="squares">
<SectionSteps title="Access Requests Flow" description={<>To learn more about access requests, take a look at <Link href="/docs/" scheme="site">Teleport Documentation</Link>.</>}>
  <SectionSteps.Item
    title="STEP 1"
    img={StepOne}
    width={363}
